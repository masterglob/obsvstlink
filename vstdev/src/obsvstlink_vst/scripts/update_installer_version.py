...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=obsvstlink_vst Demo Installer\n"
      else:
        line="OutputBaseFilename=obsvstlink_vst Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the obsvstlink_vst Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the obsvstlink_vst installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=obsvstlink_vst Demo installer\n"
     else:
       line="SetupWindowTitle=obsvstlink_vst installer\n"

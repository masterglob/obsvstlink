...
def main():
  ...
  plistpath = scriptpath + "/resources/obsvstlink_vst-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/obsvstlink_vst-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/obsvstlink_vst-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/obsvstlink_vst-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/obsvstlink_vst-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/obsvstlink_vst.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/obsvstlink_vst.iss",inplace=1):
